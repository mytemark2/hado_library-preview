...
const TABLE_BRIDGE_CHANGE_ITEMS={
  ...
  critical_tactic_rate_up:{label:'撃心発生上昇',effectFamilies:['critical_tactic_rate_up'],aliases:['撃心発生','撃心発生率','戦法撃心発生']},
  critical_tactic_power_up:{label:'撃心威力上昇',effectFamilies:['critical_tactic_power_up'],aliases:['撃心威力','戦法撃心威力']},
...
const TABLE_BRIDGE_ROWS=[
  {typeId:'vaccine',typeName:'ワクチン型',scoreMetricId:'vaccine_1',scoreMetricLabel:'弱化予防',scoreRole:'P',changeItems:['weakening_nullify','weakening_avoid'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'加点対象が0なら補助効果だけで高評価にしない。対象依存型ではunknown対象を採点対象外にする。',denyChangeItems:['defense_up','healing','wounded_recovery','wounded_survival','attribute_resistance','tactic_gauge','tactic_speed','attack_speed_up','tactic_power_up','normal_attack_target_count_up'],dedupePolicy:'evidenceGroupKey'},
  {typeId:'vaccine',typeName:'ワクチン型',scoreMetricId:'vaccine_2',scoreMetricLabel:'弱化解除',scoreRole:'P',changeItems:['weakening_remove'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'加点対象が0なら補助効果だけで高評価にしない。対象依存型ではunknown対象を採点対象外にする。',denyChangeItems:['defense_up','healing','wounded_recovery','wounded_survival','attribute_resistance','tactic_gauge','tactic_speed','attack_speed_up','tactic_power_up','normal_attack_target_count_up'],dedupePolicy:'evidenceGroupKey'},
  {typeId:'vaccine',typeName:'ワクチン型',scoreMetricId:'vaccine_3',scoreMetricLabel:'状態異常対策',scoreRole:'P',changeItems:['status_nullify','status_remove','control_counter'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'加点対象が0なら補助効果だけで高評価にしない。対象依存型ではunknown対象を採点対象外にする。',denyChangeItems:['defense_up','healing','wounded_recovery','wounded_survival','attribute_resistance','tactic_gauge','tactic_speed','attack_speed_up','tactic_power_up','normal_attack_target_count_up'],dedupePolicy:'evidenceGroupKey'},
  {typeId:'vaccine',typeName:'ワクチン型',scoreMetricId:'vaccine_4',scoreMetricLabel:'連鎖阻害対策',scoreRole:'P',changeItems:['severance_counter','isolation_counter','chain_nullify_counter'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'加点対象が0なら補助効果だけで高評価にしない。対象依存型ではunknown対象を採点対象外にする。',denyChangeItems:['defense_up','healing','wounded_recovery','wounded_survival','attribute_resistance','tactic_gauge','tactic_speed','attack_speed_up','tactic_power_up','normal_attack_target_count_up'],dedupePolicy:'evidenceGroupKey'},
  {typeId:'vaccine',typeName:'ワクチン型',scoreMetricId:'vaccine_5',scoreMetricLabel:'強化保護',scoreRole:'P',changeItems:['buff_protection'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'加点対象が0なら補助効果だけで高評価にしない。対象依存型ではunknown対象を採点対象外にする。',denyChangeItems:['defense_up','healing','wounded_recovery','wounded_survival','attribute_resistance','tactic_gauge','tactic_speed','attack_speed_up','tactic_power_up','normal_attack_target_count_up'],dedupePolicy:'evidenceGroupKey'},
  {typeId:'buff_support',typeName:'バフ支援型',scoreMetricId:'buff_support_1',scoreMetricLabel:'能力バフ配布',scoreRole:'P',changeItems:['attack_up','defense_up','intelligence_up'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'味方/自部隊への加点対象強化が0なら補助効果だけで高評価にしない。selfは許可するが味方複数配布より低く扱う。enemy対象とunknown対象は採点対象外。',denyChangeItems:[],dedupePolicy:'evidenceGroupKey'},
  {typeId:'buff_support',typeName:'バフ支援型',scoreMetricId:'buff_support_2',scoreMetricLabel:'火力バフ配布',scoreRole:'P',changeItems:['tactic_power_up','normal_attack_power_up'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'味方/自部隊への加点対象強化が0なら補助効果だけで高評価にしない。selfは許可するが味方複数配布より低く扱う。enemy対象とunknown対象は採点対象外。',denyChangeItems:[],dedupePolicy:'evidenceGroupKey'},
  {typeId:'buff_support',typeName:'バフ支援型',scoreMetricId:'buff_support_3',scoreMetricLabel:'手数バフ配布',scoreRole:'P',changeItems:['attack_speed_up','normal_attack_target_count_up'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'味方/自部隊への加点対象強化が0なら補助効果だけで高評価にしない。selfは許可するが味方複数配布より低く扱う。enemy対象とunknown対象は採点対象外。',denyChangeItems:[],dedupePolicy:'evidenceGroupKey'},
  {typeId:'buff_support',typeName:'バフ支援型',scoreMetricId:'buff_support_4',scoreMetricLabel:'会心・撃心支援',scoreRole:'P',changeItems:['critical_rate_up','critical_power_up','critical_tactic_rate_up','critical_tactic_power_up'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'味方/自部隊への加点対象強化が0なら補助効果だけで高評価にしない。selfは許可するが味方複数配布より低く扱う。enemy対象とunknown対象は採点対象外。',denyChangeItems:[],dedupePolicy:'evidenceGroupKey'},
  {typeId:'buff_support',typeName:'バフ支援型',scoreMetricId:'buff_support_5',scoreMetricLabel:'継続・保護補助',scoreRole:'S',changeItems:['effect_duration','ally_target_count','buff_protection','initial_tactic_gauge','combat_start_tactic_gauge','tactic_speed'],allowedTargets:['self','ally'],allowedSourceTypes:['tactic','skill','statusEffect','equipment','formation','fiveElement','warhorseSkill','ethnicResearchSkill'],allowedTiming:['always','tactic_activated','combat_start','on_attack','on_damaged','on_chain','on_garrison','conditional'],dependency:'加点対象強化が0なら補助評価だけで高評価にせずsupport_without_primaryとして扱う。戦法速度・初回ゲージ・対象数だけで高評価にしない。',denyChangeItems:[],dedupePolicy:'evidenceGroupKey'}
];

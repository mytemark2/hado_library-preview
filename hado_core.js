...
const SEARCH_CATEGORY_DISPLAY_ORDER=Object.freeze(['generals','tactics','skills','equipments','statusEffects','siegeWeapons','ethnicArmaments','formations','warhorses','warhorseSkills']);
...
const FILE_META={fileName:"hado_library_3.1.1.0.html",createdAt:"2026-09-03 00:00:00"};
// FEATURE[HADO-VERSIONING]: 2.x.x.y バージョン管理。メジャー/マイナーはユーザー採番、x は機能追加、y は不具合修正。
const HADO_BUILD_INFO={version:"3.1.1.0",baseVersion:"3.1.0.0",changeType:"feature-improvement",summary:"Add user-oriented copy and safe share-link features for search, details, formations, and warhorses.",baseSha256:"2594e936ddcdb1b21a6242035ebffa4e3a0a1df5"};
